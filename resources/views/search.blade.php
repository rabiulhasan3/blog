...
@push('css')
    ...
    <style>
        ...
        .slider {
            background-image: url('https://images.pexels.com/photos/66997/pexels-photo-66997.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')!important; 
        }
    </style>
@endpush
...
@section('content')
		<div class="slider display-table center-text">
			<h1 class="title display-table-cell"><b> {{ strtoupper($query) }} SEARCH POSTS</b></h1>
		</div><!-- slider -->
